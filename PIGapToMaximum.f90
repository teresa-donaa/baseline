...
!
    ...
    INTEGER :: numPeriods, iPeriod, iGame, iState, iAgent, iPrice, iThres, i, j, PathCycleStates(numStates), &
    ...
    REAL(8) :: DiscountFactors(0:numStates-1,numAgents), VisitedProfits(numStates), MaxProfits(numStates), &
